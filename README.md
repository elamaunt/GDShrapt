...
<p align="center">
  <a href="https://www.nuget.org/packages/GDShrapt.CLI"><img src="https://img.shields.io/nuget/v/GDShrapt.CLI.svg" alt="NuGet" /></a>
...
- **Current preview:** **6.0.0-alpha.3** — CLI alpha available on NuGet

🔗 NuGet (CLI alpha):  
https://www.nuget.org/packages/GDShrapt.CLI/6.0.0-alpha.3
