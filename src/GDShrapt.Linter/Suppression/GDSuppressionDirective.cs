...
namespace GDShrapt.Reader
{
    ...
    /// </summary>
    public class GDSuppressionDirective
    {
        /// <summary>
        /// The type of suppression (Ignore, Disable, Enable).
        /// </summary>
        public GDSuppressionType Type { get; }

        /// <summary>
        /// The rule IDs or names to suppress. Null means all rules.
        /// </summary>
        ...
        public GDSuppressionDirective(GDSuppressionType type, HashSet<string> ruleIds, int line, bool isInline = false)
        {
            Type = type;
            RuleIds = ruleIds;
            Line = line;
        ...
        /// </summary>
        /// <param name="ruleId">Rule ID (e.g., "GDL001").</param>
        /// <param name="ruleName">Rule name (e.g., "naming-class-case").</param>
        /// <returns>True if this directive suppresses the specified rule.</returns>
        public bool AppliesToRule(string ruleId, string ruleName)
        {
            ...
            // Check by rule name
            if (!string.IsNullOrEmpty(ruleName) && RuleIds.Contains(ruleName))
                return true;
