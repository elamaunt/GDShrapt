...
{
    public sealed class GDPropertyDeclaration : GDClassMember,
        ITokenOrSkipReceiver<GDIdentifier>,
        ITokenOrSkipReceiver<GDVarKeyword>,
        ITokenOrSkipReceiver<GDType>,
        ITokenOrSkipReceiver<GDColon>,
        ITokenOrSkipReceiver<GDExportDeclaration>,
        ITokenOrSkipReceiver<GDSetAccessorDeclarationNode>,
        ITokenOrSkipReceiver<GDGetAccessorDeclarationNode>
    {
