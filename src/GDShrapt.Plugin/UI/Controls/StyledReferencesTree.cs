...
internal partial class StyledReferencesTree : Tree
{
    ...
    private Color _highlightColor = new Color(1.0f, 0.9f, 0.0f, 0.3f); // Yellow highlight (default)

    // Confidence-based colors
    private static readonly Color HighlightColorStrict = new Color(0.3f, 0.8f, 0.3f, 0.3f);      // Green
    private static readonly Color HighlightColorPotential = new Color(1.0f, 0.7f, 0.3f, 0.3f);   // Orange
    private static readonly Color HighlightColorNameMatch = new Color(0.8f, 0.3f, 0.3f, 0.3f);   // Red
    ...
    public override void _Ready()
    {
        ...
        CallDeferred(nameof(UpdateColumnsSafe));
    }
    ...
    private void UpdateColumnsSafe()
    {
        SetColumnCustomMinimumWidth(1, 1);
        QueueRedraw();
    }
    ...
    public TreeItem CreateReferenceItem(TreeItem parent, ReferenceItem reference)
    {
        ...
        var highlightColor = reference.Confidence switch
        {
            GDReferenceConfidence.Strict => HighlightColorStrict,
            GDReferenceConfidence.Potential => HighlightColorPotential,
            GDReferenceConfidence.NameMatch => HighlightColorNameMatch,
            _ => _highlightColor
        };
