...
internal class GDCacheIndex
{
    ...
    /// </summary>
    public Dictionary<string, GDCacheFileInfo> Files { get; set; } = new();
...
/// </summary>
internal class GDCacheFileInfo
{
    /// <summary>
...
/// </summary>
internal class GDLintCacheEntry
{
    /// <summary>
...
/// </summary>
internal class GDSerializedDiagnostic
{
    ...
    /// </summary>
    public static GDSerializedDiagnostic FromDiagnostic(GDPluginDiagnostic diag)
    {
    ...
    /// </summary>
    public GDPluginDiagnostic ToDiagnostic(GDScriptFile? script = null)
    {
        return new GDPluginDiagnostic
        {
            ...
            Fixes = Array.Empty<GDCodeFix>() // Fixes need to be regenerated
        };
    }
}
