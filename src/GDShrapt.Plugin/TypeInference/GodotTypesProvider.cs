...
/// </summary>
internal class GodotTypesProvider : IGDRuntimeProvider
{
    ...
    public GodotTypesProvider()
    {
        _assemblyData = GDTypeHelper.ExtractTypeDatasFromManifest();
        BuildTypeCache();
    }

    public GodotTypesProvider(GDAssemblyData assemblyData)
    {
    ...
    public GDRuntimeMemberInfo GetMember(string typeName, string memberName)
    {
        ...
        if (!_typeCache.TryGetValue(typeName, out var typeData))
        {
            ...
            return GetMemberFromBaseType(typeName, memberName);
        }
        ...
        {
            return GetMember(typeData.GDScriptBaseTypeName, memberName);
        }
    ...
    private GDRuntimeMemberInfo GetMemberFromBaseType(string typeName, string memberName)
    {
        ...
        {
            return GetMember(typeInfo.BaseType, memberName);
        }
        return null;
    }
