...
/// </summary>
internal class GDSourceLocation
{
    /// <summary>
    ...
    /// <returns>A new GDSourceLocation instance.</returns>
    public static GDSourceLocation FromNode(GDShrapt.Reader.GDNode node, string filePath)
    {
        if (node == null)
            return null;
