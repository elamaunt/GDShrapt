...
/// </summary>
internal class GDPluginDiagnostic
{
    /// <summary>
    ...
    /// </summary>
    public GDScriptFile? Script { get; init; }
    ...
    /// </summary>
    public IReadOnlyList<GDCodeFix> Fixes { get; init; } = Array.Empty<GDCodeFix>();
    ...
    /// </summary>
    public static GDPluginDiagnosticBuilder Create(string ruleId, string message) => new(ruleId, message);
...
/// </summary>
internal class GDPluginDiagnosticBuilder
{
    ...
    private List<GDCodeFix>? _fixes;
    private string? _sourceText;
    private string? _helpUrl;

    public GDPluginDiagnosticBuilder(string ruleId, string message)
    {
        _ruleId = ruleId;
        _message = message;
    }
    ...
    public GDPluginDiagnosticBuilder WithCategory(GDDiagnosticCategory category)
    {
        _category = category;
        return this;
    }

    public GDPluginDiagnosticBuilder AtScript(GDScriptFile script)
    {
        _script = script;
        return this;
    }

    public GDPluginDiagnosticBuilder AtLocation(int line, int column)
    {
        _startLine = line;
        _startColumn = column;
        _endLine = line;
    ...
    public GDPluginDiagnosticBuilder AtSpan(int startLine, int startColumn, int endLine, int endColumn)
    {
    ...
    public GDPluginDiagnosticBuilder WithFix(GDCodeFix fix)
    {
        _fixes ??= new List<GDCodeFix>();
        _fixes.Add(fix);
        return this;
    }

    public GDPluginDiagnosticBuilder WithFix(string title, Func<string, string> apply)
    {
        return WithFix(new GDCodeFix(title, apply));
    }

    public GDPluginDiagnosticBuilder WithSourceText(string sourceText)
    {
        _sourceText = sourceText;
        return this;
    }

    public GDPluginDiagnosticBuilder WithHelpUrl(string url)
    {
        _helpUrl = url;
        return this;
    }

    public GDPluginDiagnostic Build()
    {
        return new GDPluginDiagnostic
        {
            ...
            Fixes = _fixes?.ToArray() ?? Array.Empty<GDCodeFix>(),
...
internal class GDCodeFix
{
    ...
    /// </summary>
    public GDTextReplacement? Replacement { get; init; }

    public GDCodeFix(string title, Func<string, string> apply)
    {
        Title = title;
        Apply = apply;
    }

    public GDCodeFix(string title, GDTextReplacement replacement)
    {
        Title = title;
...
/// </summary>
internal class GDTextReplacement
{
    /// <summary>
    /// Line number (0-based).
    /// </summary>
...
/// </summary>
internal class GDDiagnosticSummary
{
    /// <summary>
    /// Total error count.
    /// </summary>
    ...
    /// </summary>
    public static GDDiagnosticSummary Empty => new();
...
/// </summary>
internal class GDDiagnosticsChangedEventArgs : EventArgs
{
    /// <summary>
    /// Script that was analyzed.
    /// </summary>
    public GDScriptFile Script { get; init; } = null!;

    /// <summary>
    /// New diagnostics for the script.
    /// </summary>
    public IReadOnlyList<GDPluginDiagnostic> Diagnostics { get; init; } = Array.Empty<GDPluginDiagnostic>();

    /// <summary>
    /// Summary of all diagnostics.
    /// </summary>
    public GDDiagnosticSummary Summary { get; init; } = GDDiagnosticSummary.Empty;
}

/// <summary>
/// Event args for project-wide analysis completion.
/// </summary>
internal class GDPluginProjectAnalysisCompletedEventArgs : EventArgs
{
    /// <summary>
