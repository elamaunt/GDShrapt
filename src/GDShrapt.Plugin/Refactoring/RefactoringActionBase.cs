...
/// </summary>
internal abstract class RefactoringActionBase : IRefactoringAction
{
    public abstract string Id { get; }
    public abstract string DisplayName { get; }
    public abstract RefactoringCategory Category { get; }
    public virtual string Shortcut => null;
    public virtual int Priority => 50;

    public abstract bool IsAvailable(RefactoringContext context);
    ...
    /// </summary>
    protected abstract Task ExecuteInternalAsync(RefactoringContext context);

    /// <summary>
    /// Override to add custom validation. Return null if valid, or error message if invalid.
    /// </summary>
    protected virtual string ValidateContext(RefactoringContext context)
    {
    ...
    /// </summary>
    protected virtual void ShowError(RefactoringContext context, string message)
    {
    ...
    /// </summary>
    protected virtual void ShowWarning(RefactoringContext context, string message)
    {
        Logger.Warning($"{Id}: {message}");
    }
...
internal class RefactoringException : Exception
{
    ...
    public RefactoringException(string message, Exception innerException) : base(message, innerException) { }
}
