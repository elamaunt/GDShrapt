...
/// <summary>
/// Builds GDPluginRefactoringContext from editor state.
/// Uses GDPositionFinder for optimized AST traversal.
/// </summary>
internal class GDPluginRefactoringContextBuilder
{
    private readonly GDScriptProject _ScriptProject;
    private readonly Node _dialogParent;

    public GDPluginRefactoringContextBuilder(GDScriptProject ScriptProject, Node dialogParent = null)
    {
    ...
    /// </summary>
    public GDPluginRefactoringContext Build(IScriptEditor editor)
    {
        if (editor == null)
            return null;
    ...
    /// <summary>
    /// Creates a GDRefactoringContext from the Plugin's GDPluginRefactoringContext.
    /// This bridges the Plugin context to the Semantics context for using
    /// refactoring services from GDShrapt.Semantics.
    /// </summary>
    public GDRefactoringContext ToSemanticsContext(GDPluginRefactoringContext pluginContext)
    {
