...
/// </summary>
internal interface IRefactoringAction
{
    /// <summary>
    ...
    bool IsAvailable(RefactoringContext context);

    /// <summary>
    /// Executes the refactoring action.
    /// </summary>
    /// <param name="context">The current refactoring context.</param>
    Task ExecuteAsync(RefactoringContext context);
}

/// <summary>
/// Categories for grouping refactoring actions in menus.
/// </summary>
internal enum RefactoringCategory
{
    /// <summary>
