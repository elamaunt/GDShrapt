namespace GDShrapt.Reader
{
    ...
    {
        // Note: AddSpace, AddNewLine are defined in GDShrapt.Reader.GDReceiverExtensionMethods
        // These methods use GD.Syntax.* variants with more functionality

        public static T AddSpaceEx<T>(this T receiver, int count = 1)
        ...
        public static T AddNewLineEx<T>(this T receiver)
        ...
        // Note: Add<T, B>(T receiver, B token) is defined in GDShrapt.Reader.GDReceiverExtensionMethods
       ...
       /* public static T Add<T>(this T receiver, string value, bool multiline = false, GDStringBoundingChar boundingChar = GDStringBoundingChar.DoubleQuotas)
        ...
        // Note: AddAt is defined in GDShrapt.Reader.GDReceiverExtensionMethods
