extends Node
class_name DiagnosticsTest_CallErrors
...
func test_gd4001_invalid() -> void:
	var result := _func_two_args(1)  # GD4001: Missing second argument
	print(result)
...
func test_gd4002_invalid() -> void:
	var node: Node = Node.new()
	node.nonexistent_method_xyz()  # GD4002: MethodNotFound
...
func test_gd4005_invalid() -> void:
	emit_signal("typed_signal", 42)  # GD4005: Missing second argument
...
func test_gd4009_invalid() -> void:
	emit_signal("typed_signal", "not_int", "Name")  # GD4009: First arg should be int
