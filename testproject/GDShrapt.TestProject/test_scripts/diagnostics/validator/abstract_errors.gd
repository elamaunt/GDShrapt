...
class InvalidAbstractWithBody:
	@abstract
	func abstract_with_body() -> void:  # 28:1-GD8002-OK, 28:1-GD8001-OK
		print("This should not be here")  # GD8001: AbstractMethodHasBody


## SUPPRESSED - GD8001 suppressed
class SuppressedAbstractBody:  # 36:1-GD8002-OK
	@abstract
	# gd:ignore = GD8001
...
class ValidAbstractAnnotation:
	@abstract
	func must_implement() -> void  # 48:6-GDL203-OK


## INVALID - class has abstract methods but no @abstract annotation
class MissingAbstractAnnotation:  # GD8002: ClassNotAbstract  # 54:1-GD8002-OK
	@abstract
...
class AbstractBase:
	@abstract
	func required_method() -> int  # 65:6-GDL203-OK
...
class CannotInstantiate:
	@abstract
	func do_something() -> void  # 87:6-GDL203-OK
